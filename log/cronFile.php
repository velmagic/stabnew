...
if($isBest)
{	
	$pref = '/var/www/stabilok.ru/custom/landings/best/'; // Корень сайта
	$logDir = __DIR__.'/best/';
}
else
{	
	$pref = '/var/www/stabilok.ru/'; // Корень сайта
	$logDir = __DIR__.'/stabilok/';
}	
// Создание каталога
