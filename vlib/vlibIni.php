...
// +----------------------------------------------------------------------+
//
// Last change: 2007-01-24 8:59:28
...
if (!defined('vlibIniClassLoaded')) {
    ...
    class vlibIni {
        ...
        function vlibTemplate () {
            ...
            return array(
                'TEMPLATE_DIR' => '/usr/local/apache/htdocs/templates',   // Default directory for your template files (full path) leave the '/' or '\' off the end of the directory.

                'MAX_INCLUDES' => 2, // Drill depth for tmpl_include's

                'GLOBAL_VARS' => 0, // if set to 1, any variables not found in a loop will search for a global var as well
                ...
                'STRICT' => 0, // use DIE when encountering an incorrect tmpl_* style tags i.e. tmpl_vae
